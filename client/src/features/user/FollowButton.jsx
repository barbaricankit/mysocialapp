import { Box, Button, useToast, useDispatch, useSelector, updateUserFollowing, postFollowedUser } from '.';
...
const FollowButton = ({ user: followUser }) => {
	...
	return (
		<Button m={2} bg='rgb(29, 161, 242)' onClick={() => followedUser(followUser._id)}>
