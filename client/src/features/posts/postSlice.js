...
export const getComments = createAsyncThunk('post/comment', async (postData) => {
...
export const postComment = createAsyncThunk('get/post/comments', async (postData) => {
...
export const { addNewFeed, userLikedComment } = postSlice.actions;
